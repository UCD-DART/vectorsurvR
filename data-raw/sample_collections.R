...
sample_collections = collection[c("collection_id","collection_date"  ,"surv_year","species_display_name","sex_type","trap_acronym" ,"num_trap","trap_nights" ,"num_count","site_code")]
