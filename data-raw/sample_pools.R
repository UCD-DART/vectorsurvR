...
sample_pools = pools[c("pool_id","surv_year","collection_date","site_code" ,"species_display_name" ,"sex_type","trap_acronym" ,"num_count", "target_acronym","method_name" ,"status_name")]
